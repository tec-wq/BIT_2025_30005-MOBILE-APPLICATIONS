...
function SwitchProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME = "SwitchTrigger";
var SwitchTrigger = React5.forwardRef(
...
var SwitchBubbleInput = React5.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React5.useRef(checked);
    return (0, import_jsx_runtime3.jsx)(
      Primitive.input,
      {
        type: "checkbox",
