...
import {
  createCollection,
  useDirection
} from "./chunk-BNV7PNL4.js";
import {
  composeEventHandlers,
  useControllableState,
  usePrevious,
  useSize
} from "./chunk-32C27DHT.js";
import {
  require_react_dom
...
function createSlot2(ownerName) {
  const Slot22 = React12.forwardRef((props, forwardedRef) => {
    ...
    React12.Children.forEach(children, (maybeSlottable) => {
      var _a;
    ...
    if (slottableElement) {
      slottableElement = React12.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React12.Children.count(children) === 1 && React12.isValidElement(children)
    ) {
      slottableElement = children;
    }
    const slottableElementRef = slottableElement ? getElementRef2(slottableElement) : void 0;
    const composedRef = useComposedRefs3(forwardedRef, slottableElementRef);
    if (!slottableElement) {
      if (children || children === 0) {
        throw new Error(
    ...
    if (slottableElement.type !== React12.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React12.cloneElement(slottableElement, mergedProps);
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var getSlottableElementFromSlottable2 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
    if (!React12.isValidElement(child2)) return null;
    return React12.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React12.isValidElement(child) ? child : null;
};
...
var use2 = React12[" use ".trim().toString()];
...
function useComposedRefs4(...refs) {
  return React17.useCallback(composeRefs4(...refs), refs);
}
...
function createSlot3(ownerName) {
  const Slot22 = React18.forwardRef((props, forwardedRef) => {
    ...
    React18.Children.forEach(children, (maybeSlottable) => {
      var _a;
      if (isSlottable3(maybeSlottable)) {
        hasSlottable = true;
        const slottable = maybeSlottable;
        let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
    ...
    const mergedProps = mergeProps3(slotProps, slottableElement.props ?? {});
...
var SLOTTABLE_IDENTIFIER3 = Symbol.for("radix.slottable");
...
var getSlottableElementFromSlottable3 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
...
var createSlotError3 = (ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError3 = (ownerName) => {
  return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use3 = React18[" use ".trim().toString()];
...
function createSlot4(ownerName) {
  const Slot22 = React23.forwardRef((props, forwardedRef) => {
    ...
    React23.Children.forEach(children, (maybeSlottable) => {
      var _a;
      if (isSlottable4(maybeSlottable)) {
        hasSlottable = true;
        const slottable = maybeSlottable;
        let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
    ...
    if (slottableElement) {
      slottableElement = React23.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React23.Children.count(children) === 1 && React23.isValidElement(children)
    ) {
      slottableElement = children;
    }
    const slottableElementRef = slottableElement ? getElementRef4(slottableElement) : void 0;
    ...
    const mergedProps = mergeProps4(slotProps, slottableElement.props ?? {});
    if (slottableElement.type !== React23.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React23.cloneElement(slottableElement, mergedProps);
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var getSlottableElementFromSlottable4 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
    if (!React23.isValidElement(child2)) return null;
    return React23.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React23.isValidElement(child) ? child : null;
};
...
var createSlotError4 = (ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError4 = (ownerName) => {
  return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use4 = React23[" use ".trim().toString()];
...
var useLayoutEffect22 = (globalThis == null ? void 0 : globalThis.document) ? React26.useLayoutEffect : () => {
};
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React27.useState(void 0);
...
var PopperAnchor = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs5(forwardedRef, callbackRef);
    ...
    return virtualRef ? null : (0, import_jsx_runtime10.jsx)(
      Primitive4.div,
      {
...
var PopperContent = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs5(forwardedRef, (node) => setContent(node));
...
function useComposedRefs6(...refs) {
  return React28.useCallback(composeRefs6(...refs), refs);
}
...
function createSlot5(ownerName) {
  const Slot22 = React29.forwardRef((props, forwardedRef) => {
    ...
    React29.Children.forEach(children, (maybeSlottable) => {
      var _a;
      if (isSlottable5(maybeSlottable)) {
        hasSlottable = true;
        const slottable = maybeSlottable;
        let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
        ...
        slottableElement = getSlottableElementFromSlottable5(slottable, child);
        newChildren.push((_a = slottableElement == null ? void 0 : slottableElement.props) == null ? void 0 : _a.children);
      } else {
        newChildren.push(maybeSlottable);
      }
    ...
    if (slottableElement) {
      slottableElement = React29.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React29.Children.count(children) === 1 && React29.isValidElement(children)
    ) {
      slottableElement = children;
    }
    const slottableElementRef = slottableElement ? getElementRef5(slottableElement) : void 0;
    const composedRef = useComposedRefs6(forwardedRef, slottableElementRef);
    if (!slottableElement) {
      if (children || children === 0) {
        throw new Error(
          hasSlottable ? createSlottableError5(ownerName) : createSlotError5(ownerName)
        );
      }
      return children;
    }
    const mergedProps = mergeProps5(slotProps, slottableElement.props ?? {});
    if (slottableElement.type !== React29.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React29.cloneElement(slottableElement, mergedProps);
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var getSlottableElementFromSlottable5 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
    if (!React29.isValidElement(child2)) return null;
    return React29.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React29.isValidElement(child) ? child : null;
};
...
function isSlottable5(child) {
  return React29.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var createSlotError5 = (ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError5 = (ownerName) => {
  return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use5 = React29[" use ".trim().toString()];
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React31.useLayoutEffect : () => {
};
...
var Portal = React32.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM7.createPortal((0, import_jsx_runtime12.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot6(ownerName) {
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    let hasSlottable = false;
    const newChildren = [];
    if (isLazyComponent6(children) && typeof use6 === "function") {
      children = use6(children._payload);
    }
    React33.Children.forEach(children, (maybeSlottable) => {
      var _a;
      if (isSlottable6(maybeSlottable)) {
        hasSlottable = true;
        const slottable = maybeSlottable;
        let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
        if (isLazyComponent6(child) && typeof use6 === "function") {
          child = use6(child._payload);
        }
        slottableElement = getSlottableElementFromSlottable6(slottable, child);
        newChildren.push((_a = slottableElement == null ? void 0 : slottableElement.props) == null ? void 0 : _a.children);
      } else {
        newChildren.push(maybeSlottable);
      }
    ...
    if (slottableElement) {
      slottableElement = React33.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React33.Children.count(children) === 1 && React33.isValidElement(children)
    ) {
      slottableElement = children;
    }
    const slottableElementRef = slottableElement ? getElementRef6(slottableElement) : void 0;
    const composedRef = useComposedRefs(forwardedRef, slottableElementRef);
    if (!slottableElement) {
      if (children || children === 0) {
        throw new Error(
          hasSlottable ? createSlottableError6(ownerName) : createSlotError6(ownerName)
        );
      }
      return children;
    }
    const mergedProps = mergeProps6(slotProps, slottableElement.props ?? {});
    if (slottableElement.type !== React33.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React33.cloneElement(slottableElement, mergedProps);
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var getSlottableElementFromSlottable6 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
    if (!React33.isValidElement(child2)) return null;
    return React33.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React33.isValidElement(child) ? child : null;
};
...
function isSlottable6(child) {
  return React33.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
var REACT_LAZY_TYPE6 = Symbol.for("react.lazy");
function isLazyComponent6(element) {
  return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE6 && "_payload" in element && isPromiseLike6(element._payload);
}
function isPromiseLike6(value) {
  return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError6 = (ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError6 = (ownerName) => {
  return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use6 = React33[" use ".trim().toString()];
...
var useLayoutEffect24 = (globalThis == null ? void 0 : globalThis.document) ? React36.useLayoutEffect : () => {
};
...
function useComposedRefs7(...refs) {
  return React37.useCallback(composeRefs7(...refs), refs);
}
...
function createSlot7(ownerName) {
  const Slot22 = React38.forwardRef((props, forwardedRef) => {
    ...
    let hasSlottable = false;
    const newChildren = [];
    if (isLazyComponent7(children) && typeof use7 === "function") {
      children = use7(children._payload);
    }
    React38.Children.forEach(children, (maybeSlottable) => {
      var _a;
      if (isSlottable7(maybeSlottable)) {
        hasSlottable = true;
        const slottable = maybeSlottable;
        let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
        if (isLazyComponent7(child) && typeof use7 === "function") {
          child = use7(child._payload);
        }
        slottableElement = getSlottableElementFromSlottable7(slottable, child);
        newChildren.push((_a = slottableElement == null ? void 0 : slottableElement.props) == null ? void 0 : _a.children);
      } else {
        newChildren.push(maybeSlottable);
      }
    ...
    if (slottableElement) {
      slottableElement = React38.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React38.Children.count(children) === 1 && React38.isValidElement(children)
    ) {
      slottableElement = children;
    }
    ...
    if (!slottableElement) {
      if (children || children === 0) {
        throw new Error(
          hasSlottable ? createSlottableError7(ownerName) : createSlotError7(ownerName)
        );
      }
      return children;
    }
    const mergedProps = mergeProps7(slotProps, slottableElement.props ?? {});
    if (slottableElement.type !== React38.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React38.cloneElement(slottableElement, mergedProps);
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var getSlottableElementFromSlottable7 = (slottable, child) => {
  if ("child" in slottable.props) {
    const child2 = slottable.props.child;
    if (!React38.isValidElement(child2)) return null;
    return React38.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React38.isValidElement(child) ? child : null;
};
...
function isSlottable7(child) {
  return React38.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
var REACT_LAZY_TYPE7 = Symbol.for("react.lazy");
function isLazyComponent7(element) {
  return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE7 && "_payload" in element && isPromiseLike7(element._payload);
}
function isPromiseLike7(value) {
  return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError7 = (ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError7 = (ownerName) => {
  return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use7 = React38[" use ".trim().toString()];
...
function useMergeRefs(refs, defaultValue) {
  var callbackRef = useCallbackRef6(defaultValue || null, function(newValue) {
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React50.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React50.useCallback((option) => {
  ...
  return (0, import_jsx_runtime16.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime16.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime16.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime16.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(
      Primitive6.span,
      {
        ...
        children: (0, import_jsx_runtime16.jsx)(React50.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectIcon = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(Primitive6.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime16.jsx)(Portal, { asChild: true, ...portalProps }) });
};
...
var SelectContent = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime16.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime16.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME2;
var SelectContentFragment = React50.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM10.createPortal(
    (0, import_jsx_runtime16.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime16.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime16.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectContentImpl = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React50.useCallback(
      (candidates) => {
    ...
    return (0, import_jsx_runtime16.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime16.jsx)(Combination_default, { as: Slot8, allowPinchZoom: true, children: (0, import_jsx_runtime16.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectGroup = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime16.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime16.jsx)(Primitive6.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(Primitive6.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
      (0, import_jsx_runtime16.jsx)(Primitive6.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime16.jsx)(Primitive6.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(Primitive6.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime16.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsxs)(
      Primitive6.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) ? (0, import_jsx_runtime16.jsx)("option", { value: "" }) : null,
...
function useTypeaheadSearch(onSearchChange) {
  const handleSearchChange = useCallbackRef5(onSearchChange);
