...
var Slider = React5.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React5.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React5.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime3.jsx)(Collection.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime3.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index, isFormControl }) => (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
