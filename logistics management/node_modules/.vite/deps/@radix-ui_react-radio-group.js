...
function RadioProvider(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME = "RadioTrigger";
var RadioTrigger = React11.forwardRef(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(
      RadioProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl }) => (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
...
var RadioBubbleInput = React11.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React11.useRef(checked);
    return (0, import_jsx_runtime6.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroupItemTrigger = React22.forwardRef((props, forwardedRef) => {
...
var RadioGroupItemBubbleInput = React22.forwardRef((props, forwardedRef) => {
  const { __scopeRadioGroup, ...bubbleProps } = props;
  const radioScope = useRadioScope(__scopeRadioGroup);
  return (0, import_jsx_runtime7.jsx)(RadioBubbleInput, { ...radioScope, ...bubbleProps, ref: forwardedRef });
});
